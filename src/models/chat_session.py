...
class Message:
    ...
    timestamp: datetime = field(
        default_factory=datetime.now, metadata={"description": "Message creation time"}
    )
...
class ChatSession:
    ...
    messages: List[Message] = field(
        default_factory=list, metadata={"description": "List of conversation messages"}
    )
    metadata: Dict[str, Any] = field(
        default_factory=dict, metadata={"description": "Additional session metadata"}
    )
